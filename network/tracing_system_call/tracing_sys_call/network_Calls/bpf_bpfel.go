...
type bpfMapSpecs struct {
	ArgsMapAccept  *ebpf.MapSpec `ebpf:"args_map_accept"`
	ArgsMapBind    *ebpf.MapSpec `ebpf:"args_map_bind"`
	ArgsMapConnect *ebpf.MapSpec `ebpf:"args_map_connect"`
	ArgsMapListen  *ebpf.MapSpec `ebpf:"args_map_listen"`
	ArgsMapSocket  *ebpf.MapSpec `ebpf:"args_map_socket"`
}
...
// It can be passed to loadBpfObjects or ebpf.CollectionSpec.LoadAndAssign.
type bpfMaps struct {
	ArgsMapAccept  *ebpf.Map `ebpf:"args_map_accept"`
	ArgsMapBind    *ebpf.Map `ebpf:"args_map_bind"`
	ArgsMapConnect *ebpf.Map `ebpf:"args_map_connect"`
	ArgsMapListen  *ebpf.Map `ebpf:"args_map_listen"`
	ArgsMapSocket  *ebpf.Map `ebpf:"args_map_socket"`
}
